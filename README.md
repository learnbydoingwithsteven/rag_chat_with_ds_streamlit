...
### Screenshot 1
![Screenshot 1](data_formulator/屏幕截图 2025-04-29 141553.png)
*Dashboard displaying key metrics and summary statistics.*

### Screenshot 2
![Screenshot 2](data_formulator/屏幕截图 2025-04-29 141636.png)
*Dashboard with interactive filters for data segmentation.*

### Screenshot 3
![Screenshot 3](data_formulator/屏幕截图 2025-04-29 141710.png)
*Time series visualization showing trends over time.*

### Screenshot 4
![Screenshot 4](data_formulator/屏幕截图 2025-04-29 141827.png)
*Bar chart comparing categories side by side.*

### Screenshot 5
![Screenshot 5](data_formulator/屏幕截图 2025-04-29 141854.png)
*Histogram showing data distribution across bins.*

### Screenshot 6
![Screenshot 6](data_formulator/屏幕截图 2025-04-29 141935.png)
*Scatter plot illustrating correlation between two variables.*

### Screenshot 7
![Screenshot 7](data_formulator/屏幕截图 2025-04-29 142037.png)
*Map visualization of data by region.*

### Screenshot 8
![Screenshot 8](data_formulator/屏幕截图 2025-04-29 142059.png)
*Heatmap displaying intensity of values across a matrix.*

### Screenshot 9
![Screenshot 9](data_formulator/屏幕截图 2025-04-29 142251.png)
*Pie chart showing proportional breakdown of categories.*

### Screenshot 10
![Screenshot 10](data_formulator/屏幕截图 2025-04-29 142358.png)
*Dashboard with key performance indicator summary cards.*

### Screenshot 11
![Screenshot 11](data_formulator/屏幕截图 2025-04-29 142421.png)
*Panel for interactive dimension and metric selection.*

### Screenshot 12
![Screenshot 12](data_formulator/屏幕截图 2025-04-29 142454.png)
*Dashboard showing data export and download options.*

### Screenshot 13
![Screenshot 13](data_formulator/屏幕截图 2025-04-29 142709.png)
